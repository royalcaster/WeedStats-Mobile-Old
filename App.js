...
const firebaseConfig = {
  ...
  databaseURL: 'https://weedstats-1a033.firebaseio.com',
...
const handleLogin = async () => {
  try {
    const result = await Google.logInAsync({
      androidClientId: '31827165734-rdbihglcac1juesc6fkjd4bgp1c1oj2s.apps.googleusercontent.com',
...
/* useEffect(() => { 
  ...
  return (<>{user ? <Home user={user} statConfig={statConfig} toggleConfig={toggleConfig}  handleLogOut={handleLogOut} toggleCounter={toggleCounter}/> : <Login handleLogin={handleLogin}/>}</>);
}
