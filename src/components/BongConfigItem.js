...
const BongConfigItem = ({ config, onToggle }) => {
    ...
    return (
        <Pressable onPress={() => {
            ...
            <View style={active ? styles.container_active : styles.container}>
                ...
                <Image style={active ? styles.joint_img_active : styles.joint_img} source={require('./img/bong.png')}></Image>
                <Text style={active ? styles.label_active : styles.label}>Bong</Text>
