...
const VapeCounter = ({ counter, level, level_status, level_index, bg_color, toggleCounter }) => {
    ...
    return (
        <Animated.View id="joint_container" style={{
            ...
            <Image style={styles.vape_image} source={require('./img/vape.png')}/>
            ...
            <Pressable onPress={() => toggleCounter(3)} style={({pressed}) => [{backgroundColor: pressed ? "#2b2b2b" : "#383838"} ,styles.add_pressable]}>
