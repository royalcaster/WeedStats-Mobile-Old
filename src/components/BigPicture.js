...
import { View, Animated, Easing, StyleSheet, Pressable, Text, Image, Dimensions } from 'react-native'
...
const BigPicture = ({ message, show, onExit }) => {
    ...
    const chopDate = (string) => {
        var result = string.substring(8,10) + ". " + getMonth(string.substring(4,7)) + " " + string.substring(11,15);
    ...
    const getMonth = (string) => {
        switch(string){
            ...
            case "Dec": return "Dezember";
        }
    }

    return (
        <Animated.View style={[{transform: [{translateX: slideAnim}]},styles.animated]}>
            <Pressable style={styles.container} onPress={onExit}>
                <View>
                    <View style={styles.header}>
                        ...
                        <View style={{flexDirection: "row", alignItems: "center"}}>
                            ...
                            <View style={{height: "100%"}}>
                                ...
                                <Text style={[styles.username, {fontFamily: "PoppinsLight", fontSize: 14, color: "#d4d4d4"}]}>{"Am" + " " + chopDate(message.date.day) + " um " + message.date.time.substring(0,5)}</Text>
                            </View>
                        </View>
                    ...
                    <View style={{position: "absolute", bottom: 0, width: "100%"}}>
                        <Text style={[styles.mood_text,{fontFamily: "PoppinsBlack", fontSize: 40, marginBottom: -8}]}>{message.mood}/10</Text>
