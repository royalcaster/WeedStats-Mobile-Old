...
const VapeConfigItem = ({ config, onToggle }) => {
    ...
    return (
        <Pressable onPress={() => {
            ...
            <View style={active ? styles.container_active : styles.container}>
                ...
                <Image style={active ? styles.joint_img_active : styles.joint_img} source={require('./img/vape.png')}></Image>
                <Text style={active ? styles.label_active : styles.label}>Vape</Text>
