...
const StatsDashboard = () => {
    ...
    <ScrollView style={styles.container}>
        ...
        <Text style={{fontSize: 60, color: "#0080FF", fontFamily: "PoppinsBlack", marginBottom: -25}}>44,2</Text>
        <Text style={{fontSize: 13, color: "#0080FF", fontFamily: "PoppinsLight",}}>Was auch immer</Text>
        ...
        <View style={styles.card_container_wide}>
                ...
                <Text style={[styles.card_value,{fontSize: 25}]}>Hier natürlich auch</Text>
        </View>

        <View style={{height: 40}}></View>

        <Text style={[styles.card_value, {borderTopColor: "#0080FF", borderTopWidth: 2, paddingRight: 10, paddingLeft: 10}]}>28,4</Text>
        <Text style={[styles.card_label, {marginTop: -15}]}>Label 4</Text>

        <View style={{height: 20}}></View>

        <Text style={[styles.card_value, {borderTopColor: "#0080FF", borderTopWidth: 2, paddingRight: 10, paddingLeft: 10}]}>59,1</Text>
